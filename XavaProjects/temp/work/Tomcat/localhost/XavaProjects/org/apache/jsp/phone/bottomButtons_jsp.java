...
java.util.Stack previousViews = (java.util.Stack) context.get(request, "xava_previousViews");
 ...
 if (defaultAction != null) { 
      ...
      out.write("', '', false, '");
      out.print(defaultAction.getQualifiedName());
      out.write("')\"\n");
      ...
      try {
        ...
        // /phone/bottomButtons.jsp(27,0) name = action type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
        _jspx_th_xava_005fbutton_005f0.setAction(defaultAction.getQualifiedName());
...
while (it.hasNext()) {
	...
	if (action.appliesToMode(mode)) {
      ...
      try {
        ...
        // /phone/bottomButtons.jsp(50,1) name = action type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
