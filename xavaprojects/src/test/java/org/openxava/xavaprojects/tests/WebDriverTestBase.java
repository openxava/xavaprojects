...
abstract public class WebDriverTestBase extends TestCase {
	...
	protected void goModule(String module) throws Exception {
		driver.get("http://localhost:8080/xavaprojects/m/" + module);
		acceptInDialogJS(driver);
		wait(driver);
		this.module = module;
		//this.driver = driver;
	...
	private WebElement getTable(String collection) { 
		return driver.findElement(By.id("ox_xavaprojects_" + module + "__" + collection));
	}
	...
	protected String getDescriptionValue(String name) {		
		WebElement input = driver.findElement(By.name(Ids.decorate("xavaprojects", module, name + "__DESCRIPTION__")));
	...
	protected String getValue(String name) {
		WebElement input = driver.findElement(By.id(Ids.decorate("xavaprojects", module, name)));
		return input.getAttribute("value");
	}
	...
	protected void assertNoErrors() {
		WebElement errors = driver.findElement(By.id("ox_xavaprojects_" + module + "__errors"));
	...
	protected void clearListCondition() throws Exception{
		driver.findElement(By.id("ox_xavaprojects_" +  module + "__xava_clear_condition")).click();
		wait(driver);
	}

	protected void setConditionValue(String value, int column) {
		driver.findElement(By.id("ox_xavaprojects_" + module + "__conditionValue___" + String.valueOf(column))).sendKeys(value); 		
	}
	
	protected void setConditionComparator(String value, int column) throws Exception {
		WebElement selectCondition = driver.findElement(By.id("ox_xavaprojects_" + module + "__conditionComparator___" + String.valueOf(column)));
	...
	protected void login(String user, String password) throws Exception {
		WebElement userField = driver.findElement(By.id("ox_xavaprojects_SignIn__user"));
		userField.sendKeys(user);
		WebElement passwordField = driver.findElement(By.id("ox_xavaprojects_SignIn__password"));
